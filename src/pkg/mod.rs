...
const TRUSTED_KEY_ID: &str = "ferrumos-release-2";
const TRUSTED_PUBLIC_KEY: [u8; 32] = [
    0xa9, 0xeb, 0x42, 0x04, 0xde, 0xf7, 0x76, 0x64, 0x73, 0xeb, 0x75, 0x3b, 0x89, 0x61, 0x70, 0xce,
    0xe4, 0x41, 0xe9, 0x82, 0xfa, 0xb1, 0x9c, 0x82, 0xce, 0x48, 0x72, 0x42, 0xe5, 0xfb, 0x49, 0x18,
];
