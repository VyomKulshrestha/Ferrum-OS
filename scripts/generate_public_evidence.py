...
def aggregate_benchmarks() -> dict:
    ...
    summary = {
        ...
        "physical_simulator_jepa": {
            ...
            "claim_boundary": "Reports and papers provide defensive state-distribution priors, not Ferrum trajectories or danger labels. Every transition and label is generated by the deterministic simulator; the artifact is permanently shadow-only and has no actuator authority.",
        },
        "neural_synthetic": {
...
| Physical model | {physical["incident_source_count"]} incident/research sources inform deterministic simulator priors; {percent(physical["rules_plus_jepa_balanced_accuracy"])} original-split balanced accuracy; permanently shadow-only |
