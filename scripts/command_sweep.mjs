...
const tests = [
  ...
  ["clipboard set audit", "clipboard updated (generation 1)"],
  ["clipboard get", "audit"],
  ["clipboard clear", "clipboard cleared (generation 2)"],
  ["notify audit complete", "notification posted (id 1)"],
  ["notifications", "[1] audit - complete (pid 0)"],
  ["notifications clear", "cleared 1 notifications"],
  ...
  ["heliox neural", "heliox neural: usage: heliox neural <arm|disarm>"],
  ["heliox neural arm", "heliox neural: arm requested from local shell"],
  ["heliox neural disarm", "heliox neural: disarm requested from local shell"],
  ...
  ["uptime", "Uptime:"],
  ["uname", "FerrumOS v0.1.1 x86_64"],
  ["whoami", "root (uid=0, gid=0"],
  ["session guest", "session switched to guest"],
  ...
  ["clipboard get", "permission denied: clipboard:read"],
  ["notify denied body", "permission denied: notification:post"],
  ["notifications", "permission denied: notification:read"],
