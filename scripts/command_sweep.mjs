...
const tests = [
  ...
  ["users", "(none)"],
  ["run agent-bridge", "launched agent-bridge as userspace pid 3"],
  ["users", "agent-bridge"],
  ["syscall 3 5 1", "syscall result: Ok value=1"],
  ["syscall 3 1", "syscall result: Ok value="],
  ["syscall 3 2", "syscall result: Ok value="],
  ["syscall 3 3 7", "syscall result: PermissionDenied value=0"],
