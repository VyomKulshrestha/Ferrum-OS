...
4. An independently executed third-party software-physics integration through PyBullet DIRECT, with every observation labeled `simulated` and physical actuator authority disabled.
